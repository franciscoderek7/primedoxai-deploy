...
(function(global) {
  ...
  const REVENUE_QUICK = {
    ...
    archivist:  [{ label: '📄 Generate Document — $49',             url: 'https://paypal.me/derekfranciacco1/49',  primary: true }, { label: '📦 3-Doc Bundle — $99', url: 'https://paypal.me/derekfranciacco1/99', primary: false }],
    vetbot:     [{ label: '📍 GPS Pet Tracker — $49',               url: 'https://paypal.me/derekfranciacco1/49',  primary: true }, { label: '❤️ Health Monitor — $99', url: 'https://paypal.me/derekfranciacco1/99', primary: false }],
    torque:     [{ label: '🔧 Vehicle Diagnostic — $99',            url: 'https://paypal.me/derekfranciacco1/99',  primary: true }, { label: '💬 Finance Consult — $500', url: 'https://paypal.me/derekfranciacco1/500', primary: false }],
    ...
    phoenix:    [{ label: '💎 Boardroom Session — $500',            url: 'https://paypal.me/derekfranciacco1/500', primary: true }, { label: '🏢 Francisco Holdings', url: 'https://franciscoholdingsinc.com', primary: false }],
    swarm:      [{ label: '🧹 CleanSwarm Business — $299/year',     url: 'https://paypal.me/derekfranciacco1/299', primary: true }, { label: '💬 Book Demo', url: 'https://cleanswarm.ca', primary: false }],
    crate:      [{ label: '📦 Packaging Consult — $500',            url: 'https://paypal.me/derekfranciacco1/500', primary: true }, { label: '💬 Request Quote', url: 'mailto:franciscoderek7@gmail.com?subject=TechPackCage+Quote', primary: false }],
    ratehawk:   [{ label: '🏠 Mortgage Strategy — $500',            url: 'https://paypal.me/derekfranciacco1/500', primary: true }, { label: '💬 Free Rate Check', url: 'mailto:franciscoderek7@gmail.com?subject=Rate+Check', primary: false }],
    gavel:      [{ label: '⚖️ Employment Rights Review — $149',     url: 'https://paypal.me/derekfranciacco1/149', primary: true }, { label: '📄 Wrongful Dismissal Brief — $299', url: 'https://paypal.me/derekfranciacco1/299', primary: false }],
    cipher:     [{ label: '🔐 Privacy Audit — $499',                url: 'https://paypal.me/derekfranciacco1/499', primary: true }, { label: '📋 Privacy Policy — $99', url: 'https://paypal.me/derekfranciacco1/99', primary: false }],
    visapath:   [{ label: '✈️ Immigration Strategy — $499',         url: 'https://paypal.me/derekfranciacco1/499', primary: true }, { label: '💬 Free Assessment', url: 'mailto:franciscoderek7@gmail.com?subject=Immigration+Assessment', primary: false }],
    primedox:   [{ label: '🤖 AI Access — $99/year',                url: 'https://paypal.me/derekfranciacco1/99',  primary: true }, { label: '🏢 Francisco Holdings', url: 'https://franciscoholdingsinc.com', primary: false }],
  };
