...
(function(global) {
  ...
  const REVENUE_QUICK = {
    ...
    counsel:    [{ label: '🚨 BENO-X Session — $500',               url: 'https://paypal.me/derekfranciaco1/500', primary: true }, { label: '📄 Defense Document — $49', url: 'https://paypal.me/derekfranciaco1/49', primary: false }],
    ...
    archivist:  [{ label: '📄 Generate Document — $49',             url: 'https://paypal.me/derekfranciaco1/49',  primary: true }, { label: '📦 3-Doc Bundle — $99', url: 'https://paypal.me/derekfranciaco1/99', primary: false }],
    ...
    torque:     [{ label: '🔧 Vehicle Diagnostic — $99',            url: 'https://paypal.me/derekfranciaco1/99',  primary: true }, { label: '💬 Finance Consult — $500', url: 'https://paypal.me/derekfranciaco1/500', primary: false }],
    ...
    crate:      [{ label: '📦 Packaging Consult — $500',            url: 'https://paypal.me/derekfranciaco1/500', primary: true }, { label: '💬 Request Quote', url: 'mailto:franciscoderek7@gmail.com?subject=TechPackCage+Quote', primary: false }],
