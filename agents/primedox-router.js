...
(function(global) {
  ...
  const REVENUE_QUICK = {
    ...
    counsel:    [{ label: '🚨 BENO-X Session — $500',               url: 'https://paypal.me/techpetcage/500', primary: true }, { label: '📄 Defense Document — $49', url: 'https://paypal.me/techpetcage/49', primary: false }],
    ...
    archivist:  [{ label: '📄 Generate Document — $49',             url: 'https://paypal.me/techpetcage/49',  primary: true }, { label: '📦 3-Doc Bundle — $99', url: 'https://paypal.me/techpetcage/99', primary: false }],
    ...
    torque:     [{ label: '🔧 Vehicle Diagnostic — $99',            url: 'https://paypal.me/techpetcage/99',  primary: true }, { label: '💬 Finance Consult — $500', url: 'https://paypal.me/techpetcage/500', primary: false }],
