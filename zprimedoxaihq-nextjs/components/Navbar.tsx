      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-6">
            <Link
              href="#apps"
              className="text-doc-text hover:text-doc-gold transition"
            >
              Apps
            </Link>
            ...
            {user ? (
              ...
              <Link
                href="/auth/login"
                className="px-4 py-2 bg-doc-green text-white rounded-lg hover:bg-doc-green/80 transition"
              >
                Sign In
              </Link>
            )}
          ...
          <button
            ...
            className="md:hidden text-doc-gold"
      ...
      {menuOpen && (
        <div className="md:hidden bg-doc-card border-t border-doc-green/30">
          <div className="px-4 py-3 space-y-2">
            <Link
              href="#apps"
              className="block text-doc-text hover:text-doc-gold"
            >
              Apps
            </Link>
