...
**Universal pricing strategy confirmed by Derek 2026-06-19 (applies to every site EXCEPT PrimeDox AI + CCLDR, which stay frozen above):** Free Trial $0/24hr (full access, card required at signup) → Starter/Basic $49–99/mo → Professional/Pro $299–499/mo → Enterprise/Elite $999–2,499/mo → Sovereign/Agency $4,999–9,999/mo (sales-assisted). 24hr trial auto-converts to Starter via card-on-file at hour 24 (the lock-in); no card = locked read-only view. See `MASTER_PROMPT_MANUS_KEEP_BUILDING.md` CHECKPOINT v4/v5 for the full mechanic and the Manus-facing prompt.
